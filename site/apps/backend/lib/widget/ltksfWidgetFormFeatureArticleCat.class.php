...
* common settings.
*/
class ltksfWidgetFormFeatureArticleCat extends ltksfWidgetFormDialog
{
   /**
   ...
   */
   ...
   {      
      ...
      {
         $this->setOption('dialog_internal_uri', "@category_browse?channel_id={$options['channel_id']}");
      }

      if(!array_key_exists('browse_url', $options))
      {
         $this->setOption('browse_url', "@category_browse?channel_id={$options['channel_id']}");
      }
