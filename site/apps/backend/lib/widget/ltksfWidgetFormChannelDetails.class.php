...
* common settings.
*/
class ltksfWidgetFormChannelDetails extends ltksfWidgetFormDialog
{
   /**
   ...
   */
   ...
   {      
      ...
      {
         $this->setOption('dialog_internal_uri', "@article_browse?channel_id={$options['channel_id']}");
      }

      if(!array_key_exists('browse_url', $options))
      {
         $this->setOption('browse_url', "@article_browse?channel_id={$options['channel_id']}");
      }
