...
<?php unset($this->config['actions']) ?>
  ...
  public function getFormActions()
  {
    ...
    if($this->isAuditable())
    {
      $defaults = array('_delete' => null, '_history' => null, '_list' => null, '_save' => null, '_save_and_add' => null);
    }
    else
    {
      $defaults = array('_delete' => null, '_list' => null, '_save' => null, '_save_and_add' => null);
    }
    echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : $defaults) ?>;
