...
/**
 * UserChannel filter form base class.
 *
 * @package    LoveToKnow
 * @subpackage filter
 ...
 */
abstract class BaseUserChannelFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_channel_filters[%s]');
